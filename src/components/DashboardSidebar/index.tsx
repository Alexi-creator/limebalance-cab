...
interface Props {
  /** Вызывается при закрытии мобильного меню (кнопка «X» или переход по ссылке) */
  onClose?: () => void
}

/**
 * Боковая панель навигации дашборда.
 * Отображает логотип, основные пункты меню, настройки аккаунта и карточку текущего пользователя с кнопкой выхода.
 * На мобильных устройствах показывает кнопку закрытия и блок языка/темы.
 */
